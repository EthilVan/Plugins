...
import fr.ethilvan.bukkit.accounts.AccountsConfig;
import fr.ethilvan.bukkit.accounts.AccountsPlugin;
import fr.ethilvan.bukkit.accounts.RolesConfigReader;
...
public class EVAccounts implements Accounts {
    ...
    public EVAccounts(AccountsPlugin plugin, AccountsConfig config) {
        this.plugin = plugin;
        this.roles = new RolesConfigReader(config.getRoles()).read();
        this.pseudoRoles = new HashMap<String, Set<String>>();
    }
